...
import javafx.util.Duration;
	...
	public class ScoreBoard {
		...
		//	rT.setCycleCount(4);
			...
			this.fret.getChildren().addAll(outerRing, bottom, topRing, scoreText, multiplierText, XLine1, XLine2, quad1, quad2, quad3, quad4, quad5);
			fret.setScaleX(20.0 / 50.0);
			fret.setScaleY(20.0 / 50.0);
			fret.setTranslateX(1000);
